...
public class LastBill extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            ResultSet rs = c.conn().executeQuery("select * from customer where meter="+t2.getSelectedText());
            ...
            rs = c.conn().executeQuery("select * from bill where meter="+t2.getSelectedText());
