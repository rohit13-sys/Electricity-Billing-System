...
public class GenerateBill extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            rs = c.conn().executeQuery("select * from meter_info where meter_number = " + meter);
            ...
            rs = c.conn().executeQuery("select * from tax");
            if(rs.next()){
                t1.append("---------------------------------------------------------------");
                t1.append("\n\n");
            ...
            rs = c.conn().executeQuery("select * from bill where meter="+meter+" AND month = '"+c2.getSelectedItem()+"'");
